  ...
  return (
    <form className='mb-5' onSubmit={e => e.preventDefault()} >
        ...
        <div className="input-group rounded shadow-sm">
            <input type="text" id='textInput' className='form-control bg-light text-dark ' placeholder='Type from the passage above...' value={inputValue} onChange={e => setInputValue(e.target.value)} onKeyDownCapture={doesInputEqualQuoteArrayValue}/>
