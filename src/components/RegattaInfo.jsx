  ...
  return (
    <>
        <div className="my-5">
            ...
            <div class="accordion text-dark shadow-sm" id="notes">
                <div class="accordion-item bg-light">
                  <h2 class="accordion-heade" id="heading-1">
                    <button class="accordion-button fw-bold bg-light text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#note-1" aria-expanded="true" aria-controls="note-1">
                      How To Play
                    </button>
                  </h2>
                  <div id="note-1" class="accordion-collapse collapse show" aria-labelledby="heading-1" data-bs-parent="#chapters">
                ...
                <div class="accordion-item bg-light">
                  <h2 class="accordion-header" id="heading-2">
                    <button class="accordion-button collapsed fw-bold bg-light text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#note-2" aria-expanded="false" aria-controls="note-2">
                      Improve your accuracy 
                    </button>
                  </h2>
                  <div id="note-2" class="accordion-collapse collapse" aria-labelledby="heading-2" data-bs-parent="#chapters">
                    <div class="accordion-body text-start">
                ...
                <div class="accordion-item bg-light">
                  <h2 class="accordion-header" id="heading-3">
                    <button class="accordion-button collapsed fw-bold bg-light text-dark" type="button" data-bs-toggle="collapse" data-bs-target="#note-3" aria-expanded="false" aria-controls="note-3">
                      Increase Your Speed
                    </button>
                  </h2>
                  <div id="note-3" class="accordion-collapse collapse" aria-labelledby="heading-3" data-bs-parent="#chapters">
                    <div class="accordion-body text-start">
